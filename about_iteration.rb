...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject operates for each element in the object it is called upon, in this case, 3 elements in an array. 
    # The first argument is the result/output, the second argument is the element in the array to iterate through.
